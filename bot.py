        ...
        if m.chat.type == enums.ChatType.PRIVATE:
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            "💬 Community", url="https://t.me/")
                    ], [
                        InlineKeyboardButton(
                            "➕ Add me to your Chat ➕", url="https://t.me/BotUsername?startgroup")
                    ]
                ]
            )
            add_user(m.from_user.id)
            await m.reply_photo("https://telegra.ph/file/a782e3bbbe40df8a4bb67.jpg", caption="**🦊 Hello {}!\nI'm an auto approve [Admin Join Requests]({}) Bot.\nI can approve users in Groups/Channels.Add me to your chat and promote me to admin with add members permission.\n\n__r**".format(m.from_user.mention, "https://t.me/telegram/153"), reply_markup=keyboard)
            ...
            keyboar = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            "💁‍♂️ Start me private 💁‍♂️", url="https://t.me/BotUsername?start=start")
                    ]
                ]
            )
            add_group(m.chat.id)
...
async def chk(_, cb: CallbackQuery):
    try:
        ...
        if cb.message.chat.type == enums.ChatType.PRIVATE:
            ...
            await cb.message.edit("**🦊 Hello {}!\nI'm an auto approve [Admin Join Requests]({}) Bot.\nI can approve users in Groups/Channels.Add me to your chat and promote me to admin with add members permission.\n\n__**".format(cb.from_user.mention, "https://t.me/telegram/153"), reply_markup=keyboard, disable_web_page_preview=True)
        print(cb.from_user.first_name + " has started Your Bot!")
    except UserNotParticipant:
        await cb.answer("🙅‍♂️ You have not joined my channel 🙅‍♂️")
